...
class Character:
    ...
    def __init__(self, **kwargs):
        ...
        """
        self.character_data = dict(Character.default_character_data)
        self.character_data = Character.default_character_data
...
def main():
    ...
    print(f'Weapon: {my_character["weapon"]}')
    print(f'Gender: {my_character["gender"]}')
